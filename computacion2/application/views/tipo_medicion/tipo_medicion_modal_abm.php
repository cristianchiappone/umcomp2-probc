...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            <?php echo $fields['color_linea']['label']; ?>
            <?php echo $fields['color_linea']['form']; ?>
        </div>
    </div>
</div>
<div class="modal-footer">
    ...
    <?php echo ($txt_btn === 'Editar' || $txt_btn === 'Eliminar' || $txt_btn === 'Dar de baja') ? form_hidden('id', $tipo_medicion->id) : ''; ?>
</div>
<?php echo form_close(); ?>
<script>
